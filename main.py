...
PROMPTS_business_Qgenerator = {
    "business_Qgenerator": {
        ...
        ❶ 以下の指針に基づき、業務・案件マッチングに必要な経験・スキル情報を深く収集するため、インタビュイーに質問すること。
            ...
            ・★質問カテゴリーの9項目（直近の実績、人材種別１、アピールポイント、稼働率、稼働開始可能日、希望単価、リモート希望、可能地域、英語スキル）については、必ずすべて質問して情報を収集すること。
        ❷ 以下の質問カテゴリーを参考に、状況に応じて質問を選択・組み合わせること。
        ❸ ★質問カテゴリーの9項目がすべて収集されていることを確認してから、ヒアリングで収集した主要経験・スキル情報を簡潔に要約し、インタビュイーに確認を求めること。
        ...
        （具体的な質問例）
        インタビュイー: PythonとJavaScriptを使ってWebアプリケーションを開発しています。
